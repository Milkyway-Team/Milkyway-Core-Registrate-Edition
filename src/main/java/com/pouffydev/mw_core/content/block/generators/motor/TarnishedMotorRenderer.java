...
public class TarnishedMotorRenderer extends KineticBlockEntityRenderer<TarnishedMotorBlockEntity> {
    ...
    @Override
    protected SuperByteBuffer getRotatedModel(TarnishedMotorBlockEntity be, BlockState state) {
