...
public class WeldingRecipe extends ProcessingRecipe<RecipeWrapper> implements IAssemblyRecipe {
    ...
    public WeldingRecipe(ProcessingRecipeBuilder.ProcessingRecipeParams params) {
        super(AllRecipeTypes.WELDING, params);
    }
    ...
    public void addRequiredMachines(Set<ItemLike> list) {
        list.add(MWBlocks.WELDER.get());
    }

    @Override
    public Supplier<Supplier<SequencedAssemblySubCategory>> getJEISubCategory() {
        return () -> AssemblyWelding::new;
    }
}
