...
public class TarnishedBladeRenderer extends CustomRenderedItemModelRenderer {
    protected static final PartialModel GEAR = new PartialModel(MWCore.asResource("item/tarnished_blade/gear"));
    protected static final PartialModel CORE = new PartialModel(MWCore.asResource("item/tarnished_blade/core"));
    protected static final PartialModel CORE_GLOW = new PartialModel(MWCore.asResource("item/tarnished_blade/core_glow"));
    @Override
