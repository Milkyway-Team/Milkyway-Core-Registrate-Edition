...
public class TarnishedDeforesterRenderer extends CustomRenderedItemModelRenderer {
    protected static final PartialModel GEAR = new PartialModel(MWCore.asResource("item/tarnished_deforester/gear"));
    protected static final PartialModel CORE = new PartialModel(MWCore.asResource("item/tarnished_deforester/core"));
    protected static final PartialModel CORE_GLOW = new PartialModel(MWCore.asResource("item/tarnished_deforester/core_glow/item"));
    @Override
