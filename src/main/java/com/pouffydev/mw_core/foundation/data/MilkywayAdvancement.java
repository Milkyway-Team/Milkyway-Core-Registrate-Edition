...
public class MilkywayAdvancement {
	...
	public MilkywayAdvancement(String id, UnaryOperator<Builder> b) {
		...
		MWAdvancements.ENTRIES.add(this);
	}
	...
	public boolean isAlreadyAwardedTo(Player player) {
		...
		Advancement advancement = sp.getServer()
			.getAdvancements()
			.getAdvancement(MWCore.asResource(id));
		if (advancement == null)
			return true;
	...
	void save(Consumer<Advancement> t) {
		...
		datagenResult = builder.save(t, MWCore.asResource(id)
			.toString());
	}
	...
	class Builder {
		...
		Builder after(MilkywayAdvancement other) {
			MilkywayAdvancement.this.parent = other;
			return this;
		}
		...
		Builder title(String title) {
			MilkywayAdvancement.this.title = title;
			return this;
		}

		Builder description(String description) {
			MilkywayAdvancement.this.description = description;
			return this;
		}
