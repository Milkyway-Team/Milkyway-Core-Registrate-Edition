...
import com.pouffydev.mw_core.mixin.CreateAdvancementConstructor;
...
public class MilkywayAdvancement {
	...
	//@Nullable
	//protected final MilkywayAdvancement parent;
	//@Nullable
	//protected final CreateAdvancement createAdvancement;
	//protected Advancement advancement;
	//
	//protected MilkywayAdvancement(String id, Advancement.Builder builder, @Nullable MilkywayAdvancement parent, boolean builtin, String title, String description) {
	//	this.id = MWCore.asResource(id);
	//	this.builder = builder;
	//	this.parent = parent;
	//	if(builtin) {
	//		this.builtinTrigger = MWTriggers.addSimple("builtin/" + id);
	...
	//	this.titleKey = new StringJoiner(".").add("advancement").add(MWCore.ID).add(id).toString();
	...
	//	@Nullable
	//	private MilkywayAdvancement parent;
	...
	//		this.id = id;
	//		this.background = "root".equals(id) ? MWCore.asResource("textures/gui/advancements.png") : null;
	//	}
	//
	...
	//		return this;
	//	}
	//	protected Builder awardedForFree() {
	//		return externalTrigger("awarded_for_free", InventoryChangeTrigger.TriggerInstance.hasItems(new ItemLike[] {}));
	//	}
	//	protected Builder whenIconCollected() {
	//		return externalTrigger("icon_collected", InventoryChangeTrigger.TriggerInstance.hasItems(icon.getItem()));
	//	}
	...
	//	}
	//
	//	protected Builder parent(MilkywayAdvancement advancement) {
	...
	//	}
	//
	//	protected MilkywayAdvancement build() {
	//		if (hide) description += "\u00A77\n(Hidden Advancement)";
	//		MilkywayAdvancement advancement = new MilkywayAdvancement(id, builder, parent, builtin, title, description);
	//		builder.display(
	//				icon,
	...
	//				hide
	//		);
	//		MWAdvancements.ENTRIES.add(advancement);
	//		return advancement;
	//	}
	//
	//}
