package com.pouffydev.mw_core.foundation.util;
...
public class MWShapes {

    public static final VoxelShaper
            SLAB_LOWER = shape(0, 0, 0, 16, 8, 16).forDirectional(),
            SLAB_UPPER = shape(16, 8, 16, 16, 16, 16).forDirectional()
